...
| `probe.json`, `tor_probe.json`, `results.json`, `clearance.json`, `render.json`, `headless.json`, `solvers.json` | Recorded output. Committed as a baseline — a diff after a change is the fastest way to see what moved. |
